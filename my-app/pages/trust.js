...
export default function Trust() {
  ...
  let date = new Date(unlock_unix_timestamp * 1000);
  console.log(date);
  ...
  let formattedUnlockTime = hours + ':' + minutes.substr(-2) + ':' + seconds.substr(-2) + ' ' + days[day] + ' ' + year;
    ...
    <div className={styles.main}>
      <div>
        ...
        <div className={styles.description}>
          <p>Name: {trust_name}</p>
          <p>Unlock Time: {formattedUnlockTime}</p>
